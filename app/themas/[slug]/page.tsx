...
// Mapping van slugs naar "De Wereld van..." titels
const slugToTitleMap: Record<string, string> = {
  'de-molens': 'de Molens',
  'verkade-en-de-fabriek': 'Verkade & de Fabriek',
  'walvisvaart': 'de Walvisvaart',
  'de-polders': 'de Polders',
  'monet-en-de-zaan': 'Monet & de Zaan',
  'de-rode-zaan': 'de Rode Zaan',
  'hembrug-en-innovatie': 'Hembrug & Innovatie',
  'cacao-en-voedsel': 'Cacao & Voedsel',
}
...
export default async function ThemeDetailPage({ params }: PageProps) {
  ...
  const tabs: Array<{ id: string; label: string; subtitle?: string; content: React.ReactNode }> = []
