...
export default function PartnersPage() {
  const culturePartners = [
    ...
    'Czaar Peterhuisje',
    'Hembrugterrein',
    'Zaans Museum Verkade-collectie',
  ]

  const businessSectors = [
    { name: 'Voedselinnovatie', icon: Sprout },
    { name: 'Waterbeheer', icon: Building2 },
    { name: 'Industrieel erfgoed', icon: Factory },
    { name: 'Kunst & Cultuur', icon: Palette },
    { name: 'Molens & Energie', icon: Wind },
        ...
        <section className="bg-slate-50 py-24 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center flex flex-col items-center">
            <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold text-deep-water-blue mb-6 leading-tight">
              Bouw mee aan de Zaanse Wereld
            </h1>
            <p className="text-lg md:text-xl text-gray-700 max-w-3xl mx-auto leading-relaxed">
              Wij geloven dat onderwijs niet stopt bij de muren van de school. Samen met musea, bedrijfsleven en overheid maken we de Zaanstreek tot één groot klaslokaal.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto text-center">
            ...
            <div className="grid md:grid-cols-3 gap-8 mx-auto">
              ...
              <Card className="h-full hover:shadow-lg transition-shadow">
                ...
                <CardContent>
                  <p className="text-gray-700 mb-6 leading-relaxed text-center">
                    Voor musea en erfgoedlocaties. Wij verankeren uw collectie en verhalen in de doorlopende leerlijn van Zaanse kinderen.
                  </p>
              ...
              <Card className="h-full hover:shadow-lg transition-shadow">
                ...
                <CardContent>
                  <p className="text-gray-700 mb-6 leading-relaxed text-center">
                    Voor de koplopers van de regio. Help mee de werknemers van de toekomst te inspireren in de werelden industrie, natuur en innovatie.
                  </p>
        ...
        <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gray-50">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
              Samen bouwen we aan een netwerk dat de Zaanstreek tot een levend klaslokaal maakt.
            </p>
        ...
        <section className="py-24 px-4 sm:px-6 lg:px-8 bg-white">
          <div className="max-w-4xl mx-auto text-center flex flex-col items-center">
            ...
            <p className="text-lg text-gray-700 mb-8 max-w-2xl mx-auto">
              Neem contact met ons op of download onze visie-brochure om meer te leren over De Zaanse Wereld.
            </p>
