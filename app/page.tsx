...
// THEMES array met Zaanse werelden gebaseerd op de 3 pijlers: Mens, Industrie en Natuur
const THEMES = [
  {
    id: 1,
    title: 'De Wereld van de Molens',
    description: 'Wind, Water & Industrie',
    icon: Wind,
    color: 'text-cyan-700',
    iconBg: 'bg-cyan-100',
    link: '/themas/de-molens',
    pijler: 'industrie',
  },
  {
    id: 2,
    title: 'De Wereld van Verkade & de Fabriek',
    description: 'Arbeid, Innovatie & Sociale Geschiedenis',
    icon: Factory,
    color: 'text-amber-700',
    iconBg: 'bg-amber-100',
    link: '/themas/verkade-en-de-fabriek',
    pijler: 'mens',
  },
  {
    id: 3,
    title: 'De Wereld van de Walvisvaart',
    description: 'Scheepsbouw, Handel & Globalisering',
    icon: Ship,
    color: 'text-blue-700',
    iconBg: 'bg-blue-100',
    link: '/themas/walvisvaart',
    pijler: 'industrie',
  },
  {
    id: 4,
    title: 'De Wereld van de Polders',
    description: 'Waterbeheer, Maakbaarheid & Natuur',
    icon: Waves,
    color: 'text-teal-700',
    iconBg: 'bg-teal-100',
    link: '/themas/de-polders',
    pijler: 'natuur',
  },
  {
    id: 5,
    title: 'De Wereld van Monet & de Zaan',
    description: 'Kunst, Cultuur & Landschap',
    icon: Palette,
    color: 'text-purple-700',
    iconBg: 'bg-purple-100',
    link: '/themas/monet-en-de-zaan',
    pijler: 'natuur',
  },
  {
    id: 6,
    title: 'De Wereld van de Rode Zaan',
    description: 'Burgerschap, Solidariteit & Democratie',
    icon: Users,
    color: 'text-rose-700',
    iconBg: 'bg-rose-100',
    link: '/themas/de-rode-zaan',
    pijler: 'mens',
  },
  {
    id: 7,
    title: 'De Wereld van Hembrug & Innovatie',
    description: 'Technologie, Transformatie & Toekomst',
    icon: Cog,
    color: 'text-slate-700',
    iconBg: 'bg-slate-100',
    link: '/themas/hembrug-en-innovatie',
    pijler: 'industrie',
  },
  {
    id: 8,
    title: 'De Wereld van Cacao & Voedsel',
    description: 'Voedselinnovatie, Duurzaamheid & Circulair',
    icon: Sprout,
    color: 'text-green-700',
    iconBg: 'bg-green-100',
    link: '/themas/cacao-en-voedsel',
    pijler: 'natuur',
  },
]
        ...
        <section className="relative bg-gradient-to-b from-white to-gray-50 py-12 sm:py-16 md:py-24 lg:py-32 px-4 sm:px-6 lg:px-8 overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto text-center px-4">
            <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-deep-water-blue mb-4 sm:mb-6 md:mb-8 leading-tight">
              Welkom in de Zaanse Wereld
            </h1>
            <p className="text-base sm:text-lg md:text-xl text-gray-700 max-w-3xl mx-auto leading-relaxed">
              Een ontdekkingsreis voor leerlingen, dwars door de geschiedenis, industrie en natuur van de Zaanstreek - het oudste industriegebied van Europa.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-4 sm:gap-6 md:gap-8 mb-8 sm:mb-10 md:mb-12">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-white/10 rounded-lg p-4">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-sm">Regionale Zaanstreek-context</span>
                    </div>
                    <div className="h-2 bg-white/20 rounded-full overflow-hidden">
              ...
              <div className="bg-gradient-to-br from-polder-green to-green-700 rounded-lg p-8 text-white shadow-lg">
                ...
                <div className="space-y-4">
                  <div className="bg-white/10 rounded-lg p-4">
                    <h4 className="font-semibold mb-2">Kwalificatie</h4>
                    <p className="text-sm text-white/90">Kennis en vaardigheden verwerven</p>
                  </div>
                  <div className="bg-white/10 rounded-lg p-4">
                    <h4 className="font-semibold mb-2">Socialisatie</h4>
                    <p className="text-sm text-white/90">Deelnemen aan culturele tradities</p>
                  </div>
                  <div className="bg-white/10 rounded-lg p-4">
                    <h4 className="font-semibold mb-2">Persoonsvorming</h4>
            ...
            <div className="bg-gray-50 rounded-lg p-8 border border-gray-200">
              ...
              <div className="grid md:grid-cols-5 gap-4">
                {[
                  ...
                  { phase: 'Activering', description: 'Ervaring opdoen' },
                  { phase: 'Concretisering', description: 'Verdiepen en onderzoeken' },
