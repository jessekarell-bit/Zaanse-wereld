        ...
        <section className="bg-gradient-to-b from-white to-gray-50 py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-5xl mx-auto text-center space-y-6">
            ...
            <p className="text-lg md:text-xl text-gray-700 max-w-3xl mx-auto">
              Een strategische verbinding tussen de landelijke kerndoelen (SLO 2025) en de kracht van de Zaanstreek - het oudste industriegebied van Europa.
            </p>
          </div>
        </section>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <Card className="h-full">
                ...
                <CardContent className="text-gray-700 leading-relaxed">
                  ...
                  wanneer zij de wereld kunnen doorgronden vanuit een herkenbare context. De Zaanstreek fungeert als een
                  &apos;levend laboratorium&apos; waarin abstracte doelen concreet worden - van de molens tot Monet, van Verkade tot de walvisvaart.
                </CardContent>
              </Card>
              <Card className="h-full">
                <CardHeader>
            ...
            <div className="grid lg:grid-cols-3 gap-8 items-center">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <div className="flex justify-between text-sm font-semibold text-polder-green mb-2">
                        <span>30% Vrije Ruimte</span>
                        <span>Zaanse thematische cyclus</span>
                      </div>
                      <div className="h-3 rounded-full bg-gray-200 overflow-hidden">
                        <div className="h-full w-[30%] bg-polder-green" />
                      </div>
                      <p className="text-gray-700 mt-2">
                        Een tweejarige thematische cyclus rondom de drie pijlers Mens, Industrie en Natuur. Deze vrije ruimte wordt ingezet voor diepgaand thematisch werk en regionale verankering.
                      </p>
                    </div>
                  </div>
                </CardContent>
              ...
              <Card className="text-center p-6">
                ...
                <p className="text-gray-700 leading-relaxed">
                  De Zaanse identiteit geeft betekenis aan landelijke kerndoelen. Leerlingen ervaren dat hun leefomgeving ertoe doet - van Czaar Peter tot Monet, van de molens tot het Hembrugterrein.
                </p>
              </Card>
            </div>
          </div>
